...
void account_set_email(account_t *acc, const char *new_email)
{
	...
	strncpy(acc->email, new_email, EMAIL_LENGTH); // safe as new_email must be valid & null-terminated according to preconditions, and acc must be non-`NULL` according to preconditions
