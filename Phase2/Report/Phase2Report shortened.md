...
5. Salting and Hashing using Sodium and Argon2
    ...
    - Similarly, we have used a resonable number (measured in KiB) for the time and mem
...
10. Casting user->account_id to int
...
11. Not using `LOGIN_FAIL_IP_BANNED`
...
12. Passing 10 failed logins will soft ban the account
...
14. Accepting risk of certin overflows
...
15. Type conversions from long int to int32_t in `extract_hash_components`
