...
static inline int tstfailed(void)
{
	return(!tst_result);
}

static inline int tstpassed(void)
{
	return(tst_result);
}

static inline int tstskipped(void)
{
	return(tst_result < 0);
}
